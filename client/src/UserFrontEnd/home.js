...
import styles from "./assets/css/templatemo.min.css";
...
function App() {
  ...
  return (
    <div>
      ...
      {/* Start Banner Hero */}
      <div id="template_mo_zay_hero_carousel" className="carousel slide" data-bs-ride="carousel">
      ...
      {/* Start Footer */}
      <footer className="bg-dark" id={styles.tempaltemo_footer}>
        <div className="container">
          <div className="row">
            ...
            <div className="row pt-2">
              <div className="col-12">
                <p className="text-left text-light">
                  ...
                  <a rel="noopener noreferrer" href="https://templatemo.com" target="_blank">
                    {" "}
                    TemplateMo{" "}
                  </a>
                </p>
